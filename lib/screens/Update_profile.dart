    ...
    return MaterialApp(
      ...
      theme: ThemeData( // Define your theme with Google Font
        textTheme: GoogleFonts.ubuntuTextTheme().copyWith( // Use Ubuntu font for text elements
          headline4: TextStyle(fontSize: 24, fontWeight: FontWeight.bold), // Larger title text size
          subtitle1: TextStyle(fontSize: 18), // Larger subtitle text size
          bodyText1: TextStyle(fontSize: 16), // Larger body text size
        ),
      ),
      home: Scaffold(
        appBar: AppBar(
