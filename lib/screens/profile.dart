...
import 'package:ecommerce_app/screens/Update_profile.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    Color appBarColor = _isDarkMode ? const Color.fromRGBO(51,54,72, 1) : Colors.white;
    Color textColor = _isDarkMode ? Colors.white : Colors.black;
    Color backgroundColor =
        _isDarkMode ? const Color.fromRGBO(51,54,72, 1) : const Color.fromRGBO(238, 241, 242, 1);
